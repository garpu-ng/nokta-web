...
const en: Record<string, string> = {
  ...
  "work.lichtspiel.spec": "lichtspiel · 1920 × 912 px · 24 fps · 1:45 with sound",
  ...
  "kontakt.form.done.body": "We are reading, and we will get back to you — with the right questions, not with a quote form.",
  ...
  // Alt text for the stacked project shots; {n} is the running number.
