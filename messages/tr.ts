...
const tr: Record<string, string> = {
  ...
  "prozess.step.label": "Adım",
  "prozess.ablauf.title": "Akış 01 · Mimari görselleştirme",
  "prozess.ablauf.note": "dört adım · sen karar veriyorsun",
  "prozess.cta": "Kulağa senin projen gibi mi geliyor?",
  "nokta.svc.0.short": "Model, ışık, görüntü — içeride ve dışarıda, baskı çözünürlüğünde.",
