...
const ja: Record<string, string> = {
  ...
  "point.manual.text": "Leuchtturm は私たちのハウスマニュアル。タイポグラフィの規則、グリッド、カラーシステム、印刷標準 — ここでのすべての仕事の出発点です。販売はしていません。私たちが日々そこから働く本です。それでも表紙だけで、私たちが本をどう考えているかが伝わります。組み上げられたオブジェクトとして。",
  ...
  // ── スタジオ ──────────────────────────────────────────────────────
  "studio.heading": "スタジオ",
  "studio.caption": "デザインスタジオ · デュッセルドルフ · nrw",
  "studio.p1": "nokta はデュッセルドルフのデザインスタジオです。三人で、建物、本、プリントを描いています：建築ビジュアライゼーション、エディトリアルと組版、印刷制作、CAD図面。",
  "studio.p2": "ツールとワークフローは自分たちで作ります：レンダリングのセットアップ、組版テンプレート、製版のチェック工程。プロジェクトの始まりには、一つではなく複数の案が机の上に並びます。",
