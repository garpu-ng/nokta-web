// Social card for nokta.cube (/cube) — the cobalt architectural-viz branch. See
...
export const alt = t("meta.arch.title");
...
export default function Image() {
  return renderOgImage({
    wordmark: "nokta.cube.",
    caption: t("branch.arch.tag").toLowerCase(),
    background: BRANCH_BY_KEY.arch.accent,
  });
}
