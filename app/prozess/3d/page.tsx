...
/* The 3D workflow — the four steps from sketch to finished rendering. This is
   the worked-out one of the four processes the /prozess overview names; the
   others get their own pages as they are written up. */

export async function generateMetadata(): Promise<Metadata> {
  const t = await getT();
  return { title: t("meta.prozess3d.title") };
}
...
export default async function Prozess3dPage() {
  const t = await getT();
  ...
  return (
    <div className="wa-prozess-page">
      ...
      <div className="wa-prozess-header">
        <h1 className="wa-prozess-heading">{t("prozess.3d.heading")}</h1>
