// Shared renderer for the generated social cards (app/opengraph-image.tsx +
// app/twitter-image.tsx). One flat poster: a single colour flooding the whole
// 1200×630 field, the "nokta." wordmark set large in paper, and a tiny
// lowercase caption underneath. Poster, not screenshot: no gradients, no
// shadows, no chrome.
//
...
/** Render one social card. `wordmark` is the full lockup ("nokta.");
    `caption` the lowercase line under it; `background` the flooded field. */
